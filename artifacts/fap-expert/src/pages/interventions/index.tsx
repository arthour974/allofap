                  ...
                  <CardContent className="p-5 space-y-4">
                    ...
                    <div className="space-y-3 text-sm text-slate-600 bg-slate-50 p-3 rounded-lg">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span>{intervention.vehicule.immatriculation} <span className="text-slate-400 ml-1">({intervention.vehicule.marque} {intervention.vehicule.modele})</span></span>
                      </div>
                    </div>
                    ...
                    <div className="pt-2 flex justify-between items-center text-xs text-slate-500">
                      <div className="flex items-center gap-1.5">
                        ...
                        Créé le {format(new Date(intervention.dateCreation), "dd/MM/yyyy", { locale: fr })}
                      </div>
                    </div>
                  </CardContent>
                </Card>
